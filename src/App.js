...
function App() {
  return (
    <div className="App flex flex-col">
      <div className="w-64 fixed h-screen bg-white shadow-lg">
        <div className="flex items-center justify-center mt-10">
          <img className="h-6" src={logo} alt="" />
        </div>

        <nav className="mt-10">
          <a className="flex items-center py-2 px-8 bg-gray-200 text-gray-700 border-r-4 border-gray-700" href="/#">
          ...
          <a className="flex items-center mt-5 py-2 px-8 text-gray-600 border-r-4 border-white hover:bg-gray-200 hover:text-gray-700 hover:border-gray-700" href="/#">
            <svg className="h-5 w-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
