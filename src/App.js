...
function App() {
  return ( 
    <Router> 
      <div className="flex h-screen overflow-y-hidden antialiased text-gray-900  ">
        <aside className="fixed inset-y-0 flex flex-col  w-64 overflow-hidden sm:static bg-white border-r shadow-lg">
          <nav className="flex flex-col  h-full px-2 py-4 "> 
            <div className="flex flex-col items-left justify-center flex-1 space-y-4 -mt-5"> 
              <NavLink exact={true} to="/" activeClassName="bg-gray-100 border-r-4 border-r-5 border-gray-500">
              ...
              <NavLink to="/resume" activeClassName="bg-gray-100 border-r-4 border-r-5 border-gray-500">
                <div className="flex items-center py-2 px-8 text-gray-600 hover:bg-gray-100">
                  <svg className="w-5 h-5" viewBox="0 0 20 20">
              ...
              <NavLink to="/portofolio" activeClassName="bg-gray-100 border-r-4 border-r-5 border-gray-500">
                <div className="flex items-center py-2 px-8 text-gray-600 hover:bg-gray-100">
                  <svg className="w-5 h-5 " viewBox="0 0 20 20">
                  ...
                  <span className="mx-4 font-medium">Portofolio</span>
                </div>
              </NavLink> 
              <NavLink to="/kontak" activeClassName="bg-gray-100 border-r-4 border-r-5 border-gray-500">
                <div className="flex items-center py-2 px-8 text-gray-600 hover:bg-gray-100"> 
                  ...
                  <span className="mx-4 font-medium">Kontak</span>
                </div>
              </NavLink>  
            </div> 
            <div className="flex flex-row justify-center">
              <a href="/fb#">
                <svg className="w-5 h-5 mx-3" viewBox="0 0 20 20">
                  <path fill="none" stroke="currentColor" d="M11.344,5.71c0-0.73,0.074-1.122,1.199-1.122h1.502V1.871h-2.404c-2.886,0-3.903,1.36-3.903,3.646v1.765h-1.8V10h1.8v8.128h3.601V10h2.403l0.32-2.718h-2.724L11.344,5.71z"></path>
                </svg>
              </a>
              <a href="/tw#">
                <svg className="w-5 h-5 mx-3" viewBox="0 0 20 20">
